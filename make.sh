...
icpc -shared -Wl,-soname,libwaveprop.so.1 -o libwaveprop.so.1.0  libwaveprop.o  `freetype-config --cflags` -lguide -lpng -lpngwriter -lz -lfreetype -lrt -pthread -lgsl -lgslcblas -larprec  -lfftw3_threads -lfftw3 -I/usr/local/include -L/usr/local/lib -lz
