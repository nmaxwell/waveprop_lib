...
g++ -Wall -fPIC -c waveprop.cpp -o libwaveprop.o $std_link
g++ -shared -Wl,-soname,libwaveprop.so.1 -o libwaveprop.so.1.0  libwaveprop.o  -lpng -lpngwriter -lz -lfreetype -lrt -pthread -lgsl -lgslcblas -larprec  -lfftw3_threads -lfftw3 -lz
